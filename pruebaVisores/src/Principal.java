...
import display.DisplayJAIWithPixelInfoApp;
...
public class Principal {
	...
	public static void main(String[] args) {
		...
		try {
			...
			WritableRaster raster = RasterFactory.createWritableRaster(sm, dBuffer, new Point(0,0));
			...
			//BufferedImage bi=tiledImage.getAsBufferedImage();
			//System.out.println(bi.getColorModel());
			BufferedImage bi = new BufferedImage(raster.getWidth(),raster.getHeight(), BufferedImage.TYPE_USHORT_GRAY);
			bi.setData(raster);
			...
			//BufferedImage bi = new BufferedImage(cm,(WritableRaster) raster,false,new Hashtable<String,Object>());
			//DisplayTwoSynchronizedImages ti = new DisplayTwoSynchronizedImages(bi,bi);
			DisplayJAIWithPixelInfoApp ti= new DisplayJAIWithPixelInfoApp(bi);
			ti.setVisible(true);
