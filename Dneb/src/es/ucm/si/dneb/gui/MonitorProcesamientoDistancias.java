...
import es.ucm.si.dneb.gui.MonitorProcesamientoDobles.ProgressRenderer;
...
public class MonitorProcesamientoDistancias extends JPanel{
	...
	public MonitorProcesamientoDistancias(VentanaPcpal pcpal) {
	...
	private void rellenarTabla() {
		try {
	        ArrayList<TareaProcesamiento> tareas = (ArrayList<TareaProcesamiento>) servicioGestionProcesamientos.getProcesamientosDistancia();
