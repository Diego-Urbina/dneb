...
public class CreateTask extends JPanel {
	...
	private void initComponents() {
		...
		buttonRuta.setIcon(new ImageIcon("images/carpeta.jpg"));
	...
	private void buttonSiguienteActionPerformed(ActionEvent e) {
		...
		try {
			...
			limpiarCampos();
			JOptionPane.showMessageDialog(null,"Task creada satisfactoriamente", "Operación satisfactoria", JOptionPane.INFORMATION_MESSAGE,new ImageIcon("images/TASKICON.JPG"));	
		} catch(Exception ex) {
	    	JOptionPane.showMessageDialog(null, ex.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
	    }
	}
